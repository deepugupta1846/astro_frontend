...
function NavLink(t0) {
    ...
    if ($[0] !== "4b67f724059440307b1dbcd2b29436c92468cc3f01f2d8e39e06814da03b09c3") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4b67f724059440307b1dbcd2b29436c92468cc3f01f2d8e39e06814da03b09c3";
    }
    const { href, className, children } = t0;
    if (href.startsWith("/")) {
        let t1;
        if ($[1] !== children || $[2] !== className || $[3] !== href) {
    ...
    let t1;
    if ($[5] !== children || $[6] !== className || $[7] !== href) {
...
function Header() {
    ...
    const t5 = `pill-nav flex items-center justify-center rounded-full border border-border bg-white/92 px-1 py-2 backdrop-blur-xl md:px-3 ${scrolled ? "shadow-lg" : "shadow-md"}`;
    let t6;
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = beforeLogo.map(_HeaderBeforeLogoMap);
        $[6] = t6;
    } else {
        t6 = $[6];
    }
...
function StarRow(t0) {
    ...
    if ($[0] !== "a0135378931c2a906611658447d0fd5af557f566e9a556ebb3be1063c61a8fac") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a0135378931c2a906611658447d0fd5af557f566e9a556ebb3be1063c61a8fac";
    }
    const { value } = t0;
...
function TopAstrologers(t0) {
    ...
    let t5;
    if ($[6] !== canLoop || $[7] !== list || $[8] !== reduceMotion) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
            ...
            children: [
                ...
                list.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    className: "astro-top-swiper relative mx-auto mt-12 max-w-6xl px-2 sm:px-4",
...
_s(TopAstrologers, "yAKkJs7CtWSNDV8HpmqLOOhKJtw=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "AstroCard");
